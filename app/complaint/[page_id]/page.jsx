...
const AddNewComplaint = ({params}) => {
  ...
  const handleSubmit = async () => {
    if (!textData && !image && !video) {
      alert("Empty complaints are not allowed");
      return;
    }
    ...
    try {
      ...
      const apiUrl = `${baseURL}/add-complaint.php`; // Replace this with your actual API endpoint
  ...
  return (
    <div className="max-w-[600px] h-screen w-full mx-auto bg-[#e5e5e5] relative">
      <div className="flex p-3 justify-between items-center">
        <Link href={"/home"}>
          <IoMdClose color="gray" size={24} />
        </Link>
        <div className="font-bold text-gray-600">Complaint</div>
        <Button
          variant="ghost"
